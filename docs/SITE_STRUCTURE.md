...
│   ├── facility-date-only.mjs pushの施設source確認日だけの差分を検出し無効化を遅延
...
目標タイムの選択ボタンは2:30、3:00、3:30、4:00、4:30、5:00を日英共通で提供します。
