...
2026-08-24時点で33施設を掲載しています。内訳は東京23区18、東京都その他7、埼玉8で、既存12施設に21施設を追加しました。JAAF公認確認済み18、非公認確認済み12、公認状態unknown 3です。全33施設で一般の個人利用根拠を公式sourceから確認していますが、日ごとの開放を保証する意味ではありません。

27施設が400m、23施設が全天候です。非公認でも実用的な公園track、土track、250m・300m trackを含めました。学校等で一般利用根拠を確認できない候補は掲載していません。料金は代表枠だけを記す場合があり、spike可否は29施設で未確認なので、訪問前に公式情報を確認してください。詳細集計と追加施設一覧は [拡張レポート](../research/track-expansion/dataset-expansion-report.md) にあります。
