...
2026-08-27時点で69施設を掲載しています。内訳は東京26、埼玉11、神奈川15、千葉17です。JAAF公認確認済み48、非公認確認済み12、公認状態unknown 9です。個人利用は66施設で公式根拠を確認し、主競技場が専用利用のみの1施設は `unavailable`、根拠を確定できない2施設は `unknown` としています。日ごとの開放を保証する意味ではありません。

63施設が400m、59施設が全天候です。非公認でも実用的な公園track、土track、250m・300m trackを含めました。学校等で一般利用根拠を確認できない候補は掲載していません。料金は代表枠だけを記す場合があり、spike可否は公式根拠を確認できた値だけを表示するため、多くの施設でunknownです。33施設時点の詳細集計は [拡張レポート](../research/track-expansion/dataset-expansion-report.md)、51候補の追加履歴は [Phase 2レポート](../research/track-expansion/phase2-expansion-report.md)、遡及監査と補正は [監査レポート](../research/track-expansion/current-51-audit.md)、今回の19施設と保留判断は [関東網羅性監査report](../research/track-expansion/batches/2026-08-kanto-completeness-audit-report.md) にあります。
