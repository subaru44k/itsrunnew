...
| T15 | in progress; T15A complete, T15B corrective pass pending Sol review | `8e9e726` | T15A accepted; T15BR01-R06 focused tests recorded below | Local-only implementation; no AWS/GitHub write or deployment. |
