...
function entry(jaPath, enPath) {
  ...
  return [ja, en].map((loc, index) => `  <url><loc>${loc}</loc><xhtml:link rel="alternate" hreflang="ja" href="${ja}"/><xhtml:link rel="alternate" hreflang="en" href="${en}"/><xhtml:link rel="alternate" hreflang="x-default" href="${ja}"/>${index === 0 ? '<changefreq>daily</changefreq>' : ''}</url>`).join('\n');
}
