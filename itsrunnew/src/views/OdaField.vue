      ...
      <div class="flex-grow-1">
        ...
        <v-card class="mb-3">
          <v-container>
            ...
            <div class="headline mt-3 mb-2">{{ $t("oda.opinion_title") }}</div>
