...
describe('T14D injected local upload tooling', () => {
  it('builds exact AWS arguments and never includes forbidden operations', () => {
    ...
    expect(getObjectVersionArgs(config, object, '/safe/run/read/read.json')).toContain('--version-id'); expect(restoreObjectArgs(config, object, '/safe/restore/old.json')).toContain('--if-match')
