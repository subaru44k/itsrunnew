...
import { EXPECTED_NOZOMI_JA } from '../../../tests/fixtures/nozomiRecordsExpected'
...
describe('Nozomi public parity records', () => {
  it('deep-equals the complete ordered Japanese legacy projection', () => {
    ...
    expect(records.map(({ year, dateJa, meetJa, event, result }) => [year, dateJa, meetJa, event, result])).toEqual(EXPECTED_NOZOMI_JA)
